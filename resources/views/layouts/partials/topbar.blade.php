				...
				<ul class="menu-nav">
					<li class="menu-item {{ (request()->is('dashboard')) ? 'menu-item-active' : ''}}" aria-haspopup="true">
						<a href="{{ url('/dashboard') }}" class="menu-link">
							<span class="menu-text"><i class="fa fa-home text-primary icon-2x"></i></span>
						</a>
					</li>
					<li class="menu-item menu-item-submenu menu-item-rel {{ (request()->is('properties*', 'cases*', 'submit_quotation*', 'quotations*', 'jobs*', 'inspections*')) ? 'menu-item-active' : ''}}" data-menu-toggle="click" aria-haspopup="true">
						...
						<div class="menu-submenu menu-submenu-classic menu-submenu-left">
							<ul class="menu-subnav">
								<li class="menu-item menu-item-submenu {{ (request()->is('properties*')) ? 'menu-item-active' : ''}}" aria-haspopup="false">
								...
								<li class="menu-item menu-item-submenu {{ (request()->is('inspections*')) ? 'menu-item-active' : ''}}" aria-haspopup="false">
									<a href="{{ url('/inspections') }}" class="menu-link">
										<span class="svg-icon menu-icon">
											<!--begin::Svg Icon | path:assets/media/svg/icons/Communication/Add-user.svg-->
											<i class="icon-2x text-dark-50 flaticon2-user-1"></i>
											<!--end::Svg Icon-->
								...
								<li class="menu-item menu-item-submenu {{ (request()->is('cases*')) ? 'menu-item-active' : ''}}" aria-haspopup="false">
									<a href="{{ url('/cases') }}" class="menu-link">
										<span class="svg-icon menu-icon">
											<!--begin::Svg Icon | path:assets/media/svg/icons/Communication/Add-user.svg-->
											<i class="icon-2x text-dark-50 flaticon2-user-1"></i>
											<!--end::Svg Icon-->
								...
								<li class="menu-item menu-item-submenu {{ (request()->is('quotations*', 'submit_quotation*')) ? 'menu-item-active' : ''}}" aria-haspopup="false">
								...
								<li class="menu-item menu-item-submenu {{ (request()->is('jobs*')) ? 'menu-item-active' : ''}}" aria-haspopup="false">
					...
					<li class="menu-item menu-item-submenu menu-item-rel {{ (request()->is('services*', 'service_packages*')) ? 'menu-item-active' : ''}}" data-menu-toggle="click" aria-haspopup="true">
						<a href="javascript:;" class="menu-link menu-toggle">
						...
						<div class="menu-submenu menu-submenu-classic menu-submenu-left">
							<ul class="menu-subnav">
								<li class="menu-item menu-item-submenu {{ (request()->is('services*')) ? 'menu-item-active' : ''}}" aria-haspopup="false">
								...
								<li class="menu-item menu-item-submenu {{ (request()->is('service_packages*')) ? 'menu-item-active' : ''}}" aria-haspopup="false">
									<a href="{{ url('/service_packages') }}" class="menu-link">
										<span class="svg-icon menu-icon">
											<!--begin::Svg Icon | path:assets/media/svg/icons/Communication/Add-user.svg-->
											<i class="icon-2x text-dark-50 flaticon2-user-1"></i>
											<!--end::Svg Icon-->
					...
					@role('administrator')
					<li class="menu-item menu-item-submenu menu-item-rel {{ (request()->is('property_features*', 'roles*')) ? 'menu-item-active' : ''}}" data-menu-toggle="click" aria-haspopup="true">
						<a href="javascript:;" class="menu-link menu-toggle">
						...
						<div class="menu-submenu menu-submenu-classic menu-submenu-left">
							<ul class="menu-subnav">
								<li class="menu-item menu-item-submenu {{ (request()->is('property_features*')) ? 'menu-item-active' : ''}}" aria-haspopup="false">
									<a href="{{ url('/property_features') }}" class="menu-link">
										<span class="svg-icon menu-icon">
											<!--begin::Svg Icon | path:assets/media/svg/icons/Communication/Add-user.svg-->
											<i class="icon-2x text-dark-50 flaticon2-user-1"></i>
											<!--end::Svg Icon-->
										</span>
										<span class="menu-text">Property Features</span>
									</a>
								</li>
								<li class="menu-item menu-item-submenu {{ (request()->is('roles*')) ? 'menu-item-active' : ''}}" aria-haspopup="false">
					...
					<li class="menu-item menu-item-submenu menu-item-rel {{ (request()->is('agents*', 'customers*', 'vendors*', 'staffs*')) ? 'menu-item-active' : ''}}" data-menu-toggle="click" aria-haspopup="true">
						<a href="javascript:;" class="menu-link menu-toggle">
						...
						<div class="menu-submenu menu-submenu-classic menu-submenu-left">
							<ul class="menu-subnav">
								<li class="menu-item menu-item-submenu {{ (request()->is('agents*')) ? 'menu-item-active' : ''}}" aria-haspopup="false">
									<a href="{{ url('/agents') }}" class="menu-link">
										<span class="svg-icon menu-icon">
											<!--begin::Svg Icon | path:assets/media/svg/icons/Communication/Add-user.svg-->
											<i class="icon-2x text-dark-50 flaticon2-user-1"></i>
											<!--end::Svg Icon-->
								...
								<li class="menu-item menu-item-submenu {{ (request()->is('customers*')) ? 'menu-item-active' : ''}}" aria-haspopup="false">
								...
								<li class="menu-item menu-item-submenu {{ (request()->is('staffs*')) ? 'menu-item-active' : ''}}" aria-haspopup="false">
								...
								<li class="menu-item menu-item-submenu {{ (request()->is('vendors*')) ? 'menu-item-active' : ''}}" aria-haspopup="false">
		...
		<div class="topbar-item">
			<div class="btn btn-icon w-auto btn-clean d-flex align-items-center btn-lg px-2" id="kt_quick_user_toggle">
				<div class="d-flex flex-column text-right pr-3">
					<span class="text-muted font-weight-bold font-size-base d-none d-md-inline">{{auth()->user()->username}}&nbsp;</span>
