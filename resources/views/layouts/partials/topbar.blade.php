		...
		<div class="header-menu-wrapper header-menu-wrapper-left" id="kt_header_menu_wrapper">
			...
			<div id="kt_header_menu" class="header-menu header-menu-mobile header-menu-layout-default">
				...
				<ul class="menu-nav">
					...
					<li class="menu-item menu-item-submenu menu-item-rel {{ (request()->is('properties*', 'cases*', 'submit_quotation*', 'quotations*', 'jobs*')) ? 'menu-item-active' : ''}}" data-menu-toggle="click" aria-haspopup="true">
