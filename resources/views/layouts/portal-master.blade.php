...
<html lang="en">
	...
	<head><base href="">
		...
		<link href="{!! url('assets/multi_select/bootstrap-multiselect.css') !!}" rel="stylesheet" type="text/css" />
		<!--end::Fonts-->
	...
	<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled page-loading">
		...
		<script src="{!! url('assets/multi_select/bootstrap-multiselect.js') !!}" /></script>
		<!--end::Page Vendors-->
		...
		<script src="{!! url('assets/js/pages/features/calendar/list-view.js') !!}"></script>
