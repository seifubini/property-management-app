                        ...
                        <div class="login-form login-signin">
                            ...
                            <form method="post" action="{{ route('login.perform') }}">
                                ...
                                <div class="pb-13 pt-lg-0 pt-5">
                                    <h3 class="font-weight-bolder text-dark font-size-h4 font-size-h1-lg">Welcome to DAS Portal</h3>
                                    <span class="text-muted font-weight-bold font-size-h4">New Here?
                                    <a href="{{ route('register.perform') }}" class="text-primary font-weight-bolder">Create an Account</a></span>
                                </div>
                                <!--begin::Title-->
                                <!--begin::Form group-->
                                <div class="form-group">
                                    <label class="font-size-h6 font-weight-bolder text-dark">Email or Username</label>
                                    <input class="form-control form-control-solid h-auto py-6 px-6 rounded-lg" type="text" name="username" value="{{ old('username') }}" placeholder="Email or Username" required="required" autocomplete="off" />
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control form-control-solid h-auto py-6 px-6 rounded-lg" type="password" name="password" value="{{ old('password') }}" required="required" autocomplete="off" />
