				...
				<div class="card card-custom">
					<div class="card-header">
						<div class="card-title">
							...
							<h3 class="card-label">Customers Listed</h3>
						</div>
						...
						<table class="table table-bordered table-hover table-checkable" id="kt_datatable" style="margin-top: 13px !important">
							...
							<tbody>
								...
								<tr>
									...
									<td>
										<a href="{{ route('customers.edit', $customer->id) }}" title="Edit Record" class="btn btn-sm btn-clean btn-icon">
											<i class="la la-edit"></i>
										</a>
										<a href="javascript:;" class="btn btn-sm btn-clean btn-icon" title="Delete Record" 
											data-toggle="modal" data-target="#modal-danger{{$customer->id}}">
											<i class="la la-trash"></i>
										</a>
									</td>
								</tr>
								<!-- Modal Starts Here-->
								<div class="modal fade" id="modal-danger{{$customer->id}}">
									<div class="modal-dialog">
									  <div class="modal-content bg-danger">
									    <div class="modal-header">
									      <h4 class="modal-title">Are you sure you want to delete <br> <strong>"{{ $customer->name }}"</strong> ?</h4>
