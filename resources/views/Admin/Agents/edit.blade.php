		...
		<div class="row">
			<div class="col-lg-12">
				...
				<div class="card card-custom gutter-b example example-compact">
					...
					<!--begin::Form-->
					<form class="form" method="POST" action="{{ route('agents.update', $agent->id) }}" enctype="multipart/form-data">
						@method('patch')
                        @csrf
						<div class="card-body">
							...
							<div class="form-group row">
								<div class="col-lg-6">
									<label>Email:</label>
									<input type="email" class="form-control" name="email" value="{{$agent->email}}" disabled>
								...
								<div class="col-lg-6">
									<div class="image_increment">
										...
										<select class="form-control" name="gender" id="exampleSelect1">
											<option value="{{$agent->gender}}" selected>{{$agent->gender}}</option>
