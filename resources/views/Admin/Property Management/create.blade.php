			...
			<div class="row">
				<div class="col-lg-12">
					...
					<div class="card card-custom gutter-b example example-compact">
						...
						<!--begin::Form-->
						<form class="form" method="POST" action="{{ route('properties.store') }}" enctype="multipart/form-data">
	                        @csrf
							<div class="card-body">
								...
								<div class="form-group row">
									...
									<div class="col-lg-6">
										...
										<input type="text" class="form-control" name="rent_period" placeholder="Enter rent period">
								...
								<div class="form-group row">
									<div class="col-lg-6">
										...
										<div class="input-group">
	    									<textarea class="form-control" name="description" id="exampleTextarea" placeholder="Enter your property description" rows="3"></textarea>
										</div>
									</div>
								</div>
								<hr>
								...
								<div class="form-group row">
									<div class="col-lg-6">
										<label>Address:</label>
										<div class="input-group">
											<input type="text" name="Address" class="form-control" placeholder="Enter your property address">
										</div>
									...
									<div class="col-lg-6">
										...
										<div class="input-group">
											<input type="text" name="zone" class="form-control" placeholder="Enter your property zone">
										</div>
								...
								<div class="form-group row">
									<div class="col-lg-6">
										...
										<div class="input-group">
											<input type="text" name="latitude" class="form-control" placeholder="Enter your property latitude">
											<div class="input-group-append">
									...
									<div class="col-lg-6">
										...
										<div class="input-group">
											<input type="text" name="longitude" class="form-control" placeholder="Enter your property longitude">
											<div class="input-group-append">
												<span class="input-group-text">
													<i class="la la-map-marker"></i>
												</span>
								...
								<div class="form-group row">
									<div class="col-lg-6">
										...
										<div class="input-group">
											<input type="text" class="form-control" name="property_size" placeholder="Enter your property size">
											<div class="input-group-append">
									...
									<div class="col-lg-6">
										...
										<div class="input-group">
											<input type="number" class="form-control" name="bed_rooms" placeholder="Enter number of bedrooms">
										</div>
								...
								<div class="form-group row">
									<div class="col-lg-6">
										<label>Baths:</label>
										<div class="input-group">
											<input type="text" class="form-control" name="baths" placeholder="Enter number of baths">
										</div>
									...
									<div class="col-lg-6">
										<label>Garages:</label>
										<div class="input-group">
											<input type="number" class="form-control" name="garages" placeholder="Enter number of garages">
										</div>
								...
								<div class="form-group row">
									<div class="col-lg-6">
										...
										<div class="input-group">
											<input type="number" class="form-control" name="floors" placeholder="Enter number of floors">
										</div>
									...
									<div class="col-lg-6">
										...
										<div class="input-group">
											<input type="text" class="form-control" name="building_year" placeholder="Enter building year">
										</div>
								...
								<div class="form-group row">
									<div class="col-lg-6">
										...
										<div class="input-group">
											<input type="text" class="form-control" name="video_description" placeholder="Enter property video description">
										</div>
									...
									<div class="col-lg-6">
										...
										<div class="input-group">
											<input type="text" class="form-control" name="video_url" placeholder="Enter your video link">
										</div>
								...
								<div class="form-group row">
									<div class="col-lg-6">
										...
										<div class="input-group">
											<input type="text" class="form-control" name="floor_plan_description" placeholder="Enter floor plan description">
										</div>
